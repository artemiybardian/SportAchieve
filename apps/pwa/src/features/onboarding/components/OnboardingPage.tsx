...
import onboardingNfc from '@/assets/onboarding-two.png';
import onboardingCards from '@/assets/onboarding-three.png';
...
export function OnboardingPage() {
      ...
      completeOnboarding.mutate(undefined, {
        onSettled: () => {
          const target =
            ...
            peekLastBrowsePath() ??
            (machineId ? `/exercise/machine/${machineId}` : '/exercise/machine');
          clearAuthReturnStorage();
  ...
  return (
    <div
      className={cn(
        'page-transition flex max-h-[100dvh] h-[100dvh] flex-col overflow-hidden overscroll-none bg-background',
